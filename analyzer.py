...
3. **产业链拆解**：先梳理新闻涉及的产业链环节（上游/中游/下游），再在每个环节中找公司
4. **公司分类**（三类，按弹性从高到低）：
   - **核心成长龙头**：产业链中弹性最大、增速最高的环节，有实质订单/产能/客户认证，受益逻辑最直接，业绩弹性明确
   - **有订单或业绩的龙头**：产业链其他环节有实质业务的公司，受益逻辑清晰但弹性不如核心成长
   - **概念跟风**：沾边概念但无实质业绩支撑、或仅处于送样/认证早期阶段、或受益逻辑间接
5. **公司描述要求**：每家公司必须写明——哪个产业链环节、哪个子公司/产品线、认证了哪些客户、订单规模/产能情况。不允许笼统描述。先写清楚产业链位置再列公司
...
| 代码 | 名称 | 所处环节 | 受益逻辑 | 现价 | 保守目标价 | 中性目标价 | 乐观目标价 |
|------|------|---------|---------|------|-----------|-----------|-----------|
| 000000 | XX股份 | 中游靶材 | 子公司XXX是国内XX龙头，已通过XX认证，批量供货XX，直接受益本次需求增量，业绩弹性明确 | 约X元 | X元（短期XX驱动） | X元（中期XX兑现） | X元（长期XX爆发） |
...
| 代码 | 名称 | 所处环节 | 受益逻辑 | 现价 | 保守目标价 | 中性目标价 | 乐观目标价 |
|------|------|---------|---------|------|-----------|-----------|-----------|
| 000000 | XX股份 | 上游资源 | 拥有XX产能，直接受益于需求扩容 | 约X元 | X元 | X元 | X元 |
...
| 代码 | 名称 | 所处环节 | 受益逻辑 | 现价 | 保守目标价 | 中性目标价 | 乐观目标价 |
|------|------|---------|---------|------|-----------|-----------|-----------|
| 000000 | XX股份 | XX | 间接关联，无实质订单 | 约X元 | X元 | X元 | X元 |
