...
3. **产业链拆解**：先一句话概括产业链（如"钼矿→高纯钼靶/前驱体→设备/存储"），再按环节从上到下罗列公司
4. **公司描述**：每家公司一句话写清——哪个环节、什么产品/子公司、认证/供货了哪些客户。有实质订单的写清，没订单的标"无实质订单"
5. **价格预期**：现价+保守/中性/乐观三段目标价，必须标注来源：搜到研报→"中信:20-25-30元"；搜不到→"AI综合:20-25-30元"
...
|------|------|------------------------|---------|
| 000000 | XX股份 | 中信:18-22-28元 | 子公司XX国内龙头，已通过XX认证批量供货 |

## 中游：[环节名] — 核心逻辑：[一句话]

| 代码 | 名称 | 现价-保守价-中性价-乐观价 | 受益逻辑 |
|------|------|------------------------|---------|
| 000000 | XX股份 | AI综合:7-8.5-10元 | 拥有XX产能，受益XX需求扩容 |
...
| 代码 | 名称 | 现价-保守价-中性价-乐观价 | 受益逻辑 |
|------|------|------------------------|---------|
| 000000 | XX股份 | AI综合:5-6-8元 | XX设备龙头，适配XX新工艺 |

（按产业链从上到下，每个环节1-4家公司，无实质订单的标注）
...
- **价格来源必须注明**：现价-保守-中性-乐观价格式为 `来源:价格`，如搜到券商研报/机构目标价则引用（如"中信证券:20元-25元-30元"），搜不到则标"AI综合:20元-25元-30元"。严禁裸价格
- 所有价格以人民币元为单位
- 新闻与A股完全无关 → 直接说"该新闻对A股无明显利好"并结束
- **末尾必须加**：以上分析源自公开信息与机构研报整理，AI综合部分仅供参考，不构成投资建议"""
